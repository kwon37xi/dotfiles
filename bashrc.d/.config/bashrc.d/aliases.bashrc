...
# apt update/upgrade
alias sysup='sudo apt update && sudo apt -y upgrade && sudo apt  -y autoremove && flatpak update -y && brew update && brew upgrade && brew autoremove && brew cleanup --prune=all && sdk selfupdate && sdk update'
